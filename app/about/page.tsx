...
export default async function AboutPage() {
  ...
  const data: AboutData = about
    ...
    : {
        ...
        description:
          "Rackup IT Solution is a global software agency dedicated to helping businesses transform their digital presence. Founded in 2020, we have delivered over 100+ successful projects for startups and enterprise clients alike.",
        heroImageUrl:
