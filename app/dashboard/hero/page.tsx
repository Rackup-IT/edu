        ...
        if (data._id) {
          setFormData({
            ...
            setFormData({
                ...
                subtitle: "Leading Web and Desktop Development Solutions",
    ...
    <div className="max-w-4xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-neutral-500 mt-1">Manage the main landing section content</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8 bg-white p-8 rounded-xl border border-neutral-200 shadow-sm">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
             <div>
                <label className="block text-sm font-medium text-neutral-700 mb-2">Background Color (Hex)</label>
             ...
             <div>
                <label className="block text-sm font-medium text-neutral-700 mb-2">Illustration Image</label>
                <div
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Use \n for line breaks"
            />
            <p className="text-xs text-neutral-400 mt-1">Tip: Use <code>\n</code> or <code>&lt;br /&gt;</code> for line breaks</p>
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
                <h4 className="text-sm font-bold text-neutral-900 uppercase">Primary Button</h4>
                <div>
                ...
                <div>
                    <label className="block text-sm font-medium text-neutral-700 mb-2">Link</label>
                    <input
                    type="text"
                    name="buttonLink"
            ...
            <div className="space-y-4">
                <h4 className="text-sm font-bold text-neutral-900 uppercase">Secondary Button</h4>
                <div>
                    <label className="block text-sm font-medium text-neutral-700 mb-2">Text</label>
                    <input
                    type="text"
