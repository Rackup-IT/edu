...
export default function SettingsDashboard() {
  ...
  const [formData, setFormData] = useState<SettingsData>({
    logoUrl: "",
    companyName: "Rackup IT Solution",
    footerText: "Leading Web and Desktop Development Solutions",
  });
      ...
      if (response.ok) {
        ...
        if (data._id) {
          setFormData({
            ...
            companyName: data.companyName || "Rackup IT Solution",
            footerText: data.footerText || "Leading Web and Desktop Development Solutions",
          });
        }
      }
    } catch (error) {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-neutral-900">Global Settings</h1>
          <p className="text-neutral-500 mt-1">Manage logo, company name, and footer details</p>
        </div>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
             ...
             <div className="space-y-4">
                ...
                <div>
                    <label className="block text-sm font-medium text-neutral-700 mb-2">Footer Slogan / Text</label>
                    <textarea
                        name="footerText"
